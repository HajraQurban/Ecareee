//
//  ElbowPainPopUpController.swift
//  HealthHub
//
//  Created by OBS on 25/01/2022.
//

import UIKit

class ElbowPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Elbow pain","Elbow pain, Bursitis (joint inflammation)","Broken arm","Dislocated elbow.","Golfer's elbow","Osteoarthritis (disease causing the breakdown of joints)"]
...
extension ElbowPainPopUpController: UITableViewDelegate,UITableViewDataSource{
