//
//  SelectPainLegPopUpController.swift
//  HealthHub
//
...
class SelectPainLegPopUpController: UIViewController {
    ...
    var btnsArray = ["Leg pain","Leg pain,  Peripheral Artery Disease","Deep Vein Thrombosis","Peripheral Neuropathy","Electrolyte Imbalance"]
...
extension SelectPainLegPopUpController: UITableViewDelegate,UITableViewDataSource{
