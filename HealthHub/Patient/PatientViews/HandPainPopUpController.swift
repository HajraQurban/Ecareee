...
class HandPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Hand pain","Finger pain","Thumb","Carpal Tunnel Syndrome","Arthritis","Trigger Finger"]
...
extension HandPainPopUpController: UITableViewDelegate,UITableViewDataSource{
