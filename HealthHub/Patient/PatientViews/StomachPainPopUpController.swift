//
//  StomachPainPopUpController.swift
//  HealthHub
//
...
class StomachPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Stomach pain","Stomach pain, Sharp jabbing pain in the upper right abdomen","Uncomfortable bloating","Upper stomach pain or burning sensation","Sharp pain in the lower right side of the abdomen","General abdominal pain with bloating"]
...
extension StomachPainPopUpController: UITableViewDelegate,UITableViewDataSource{
