...
class NeckPainPopupController: UIViewController {
    ...
    var btnsArray = ["Throat pain","Throat pain, Sore throat","painful swallowing","red throat","cough","shortness of breath"]
...
extension NeckPainPopupController: UITableViewDelegate,UITableViewDataSource{
