//
//  ShoulderArmPainPopUpController.swift
//  HealthHub
//
...
class ShoulderArmPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Arm pain","Arm pain, Angina (reduced blood flow to the heart)","Broken arm","Brachial plexus injury.","Broken wrist","Carpal tunnel syndrome"]
...
extension ShoulderArmPainPopUpController: UITableViewDelegate,UITableViewDataSource{
