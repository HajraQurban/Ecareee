//
//  SelectAbadomenPainPopUpController.swift
//  HealthHub
//
//  Created by OBS on 01/02/2022.
//

import UIKit

class SelectAbadomenPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Abdominal pain","Abdominal pain,  Appendicitis","perforated stomach ulcer","pancreatitis","ruptured diverticulitis"]
...
extension SelectAbadomenPainPopUpController: UITableViewDelegate,UITableViewDataSource{
