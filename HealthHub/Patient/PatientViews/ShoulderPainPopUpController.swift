//
//  ShoulderPainPopUpController.swift
//  HealthHub
//
...
class ShoulderPainPopUpController: UIViewController {
    ...
    var btnsArray = ["Shoulder pain","Shoulder pain, Brachial plexus injury","Broken arm","Broken collarbone","Bursitis (joint inflammation)","Frozen shoulder"]
...
extension ShoulderPainPopUpController: UITableViewDelegate,UITableViewDataSource{
