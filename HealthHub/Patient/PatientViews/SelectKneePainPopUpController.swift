//
//  SelectKneePainPopUpController.swift
//  HealthHub
//
...
class SelectKneePainPopUpController: UIViewController {
    ...
    var btnsArray = ["Knee pain","Knee pain,  Fractures","Anterior cruciate ligament injuries","Dislocation","Meniscal tears"]
...
extension SelectKneePainPopUpController: UITableViewDelegate,UITableViewDataSource{
