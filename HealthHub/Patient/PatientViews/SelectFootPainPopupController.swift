//
//  SelectFootPainPopupController.swift
//  HealthHub
//
...
class SelectFootPainPopupController: UIViewController {
    ...
    var btnsArray = ["Foot pain","Foot pain,  Athlete's foot","Bunions","Diabetic neuropathy","Ingrown toenails"]
...
extension SelectFootPainPopupController: UITableViewDelegate,UITableViewDataSource{
