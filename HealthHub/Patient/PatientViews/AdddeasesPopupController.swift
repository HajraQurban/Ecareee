//
//  AdddeasesPopupController.swift
//  HealthHub
//
...
class AdddeasesPopupController: UIViewController {
...
extension AdddeasesPopupController: UITableViewDelegate,UITableViewDataSource{
