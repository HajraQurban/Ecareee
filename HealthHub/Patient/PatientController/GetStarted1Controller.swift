...
class GetStarted1Controller: UIViewController {
...
//        iv.tintColor = UIColor(named: Colors.PrimaryAppColor1)
   //     iv.tintColor = redBtnColor()
    ...
    lazy var descLbl : UILabel = {
        ...
        lbl.text = "Get prescriptions on your mobile phones and stay aware of your health conditions."
        lbl.numberOfLines = 0
        lbl.sizeToFit()
        lbl.adjustsFontSizeToFitWidth = true
        lbl.translatesAutoresizingMaskIntoConstraints = false
...
//        btn.layer.borderColor =  UIColor(named:Colors.ButtonBG)?.cgColor
    ...
    func setupofUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            Getstartedlogo.topAnchor.constraint(equalTo: margin.topAnchor,constant: 42 * appConstant.heightRatio),
