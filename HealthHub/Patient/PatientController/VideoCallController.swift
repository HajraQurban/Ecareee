...
class VideoCallController: UIViewController {
    ...
    func setup(){
        ...
        NSLayoutConstraint.activate([
            ...
            ownVideoView.topAnchor.constraint(equalTo: reciverImage.topAnchor,constant: 140 * appConstant.heightRatio),
            ...
            nameLbl.topAnchor.constraint(equalTo: voliumeView.bottomAnchor,constant: 20 * appConstant.heightRatio),
...
//            videoOffBtn.trailingAnchor.constraint(equalTo: ownVideoView.leadingAnchor, constant: -0),
    ...
    func sendNotification(){
        let params : [String:Any] = ["user_id":appointment.doctor?.id ?? 0,"user_type":"doctor","appointment_id":appointment.id ?? 0]
    ...
    @objc func disconnect(sender: AnyObject) {
        if room != nil{
            VideoCallController.isInCall = false
...
//                self.micButton.setTitle("Mute", for: .normal)
    ...
    func setSpeaker(enabled:Bool) throws {
        if self.localAudioTrack != nil {
            ...
            if (enabled) {
                voliumeBtn.backgroundColor = .black
                voliumeBtn.tintColor = .white
                ...
                voliumeBtn.backgroundColor = .white
                voliumeBtn.tintColor = .blue
                try session.setActive(true)
                do {
...
//            ownVideoView.addSubview(blurredView)
    ...
    func cleanupRemoteParticipant() {
        if self.remoteParticipant != nil {
            ...
            //            self.navigationController?.pushViewController(EndCallController(), animated: true)
        }
    }
...
extension VideoCallController : VideoViewDelegate {
...
@available(iOS 13.0, *)
// MARK:- RoomDelegate
extension VideoCallController : RoomDelegate {
    func roomDidConnect(room: Room) {
        logMessage(messageText: "Waiting...")
        //(\(room.name))
        //        stopStartSound()
...
extension VideoCallController : RemoteParticipantDelegate {
    ...
    func didUnsubscribeFromAudioTrack(audioTrack: RemoteAudioTrack, publication: RemoteAudioTrackPublication, participant: RemoteParticipant) {
        ...
        logMessage(messageText: "Doctor Muted")
    }
    ...
    func remoteParticipantDidDisableVideoTrack(participant: RemoteParticipant, publication: RemoteVideoTrackPublication) {
        ...
        logMessage(messageText: "Doctor Stop Video")
    }
