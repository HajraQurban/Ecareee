//
//  HealthhistoryController9.swift
//  HealthHub
//
...
protocol history9Delegate{
    func slider9BtnPress()
}

var history9Data : history9Delegate?

class HealthhistoryController9: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Have you been diagnosed with any pulmonary condition?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    {
        pulmonary = "Yes"
        AppUserDefault.shared.pulmonary = pulmonary
        history9Data?.slider9BtnPress()
