//
//  HealthhistoryController2.swift
//  HealthHub
//
...
protocol history2Delegate{
    func slider2BtnPress()
}

var history2Data : history2Delegate?

class HealthhistoryController2: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Do you have type 1 diabetes?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    {
        diabetes = "Yes"
        AppUserDefault.shared.diabetes = diabetes
        history2Data?.slider2BtnPress()
