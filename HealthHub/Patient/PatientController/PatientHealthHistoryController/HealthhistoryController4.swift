//
//  HealthhistoryController4.swift
//  HealthHub
//
...
protocol history4Delegate{
    func slider4BtnPress()
}

var history4Data : history4Delegate?

class HealthhistoryController4: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Are you allergic to any medication?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
...
//            headtitleLbl.heightAnchor.constraint(equalToConstant: 80 * appConstant.heightRatio),
    ...
    {
        allergy = "Yes"
        AppUserDefault.shared.allergy = allergy
        history4Data?.slider4BtnPress()
