//
//  HealthhistoryController7.swift
//  HealthHub
//
...
protocol history7Delegate{
    func slider7BtnPress()
}

var history7Data : history7Delegate?

class HealthhistoryController7: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Have you been diagnosed with any kidney condition?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    {
        kindny = "Yes"
        AppUserDefault.shared.kindny = kindny
        history7Data?.slider7BtnPress()
