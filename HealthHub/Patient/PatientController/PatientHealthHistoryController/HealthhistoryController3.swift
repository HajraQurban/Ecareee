//
//  HealthhistoryController3.swift
//  HealthHub
//
...
protocol history3Delegate{
    func slider3BtnPress()
}

var history3Data : history3Delegate?

class HealthhistoryController3: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Do you have asthma or epilepsy?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
...
//            headtitleLbl.heightAnchor.constraint(equalToConstant: 80 * appConstant.heightRatio),
    ...
    {
        epilepsy = "Yes"
        AppUserDefault.shared.epilepsy = epilepsy
        history3Data?.slider3BtnPress()
