//
//  HealthhistoryController1.swift
//  HealthHub
//
...
protocol history1Delegate{
    func slider1BtnPress()
}

var history1Data : history1Delegate?

class HealthhistoryController1: UIView {
...
//
    ...
    {
        smoke = "Yes"
        AppUserDefault.shared.smoke = smoke
        history1Data?.slider1BtnPress()
...
//        {
            ...
            AppUserDefault.shared.smoke = smoke
//            sender.backgroundColor = UIColor(named: Colors.ButtonBG)
//            yesBtn.backgroundColor = UIColor.lightGray
//            dontknowBtn.backgroundColor = UIColor.lightGray
//        }
    }
...
//class HealthhistoryController1: BaseController {
//
//    lazy var headtitleLbl : UILabel = {
//        let lbl = UILabel()
//        lbl.clipsToBounds = true
...
//          //  logoImage.centerXAnchor.constraint(equalTo: numberingtitleLbl.centerXAnchor, constant: 0 * appConstant.heightRatio),
//            logoImage.leadingAnchor.constraint(equalTo: childView.leadingAnchor, constant: 59 * appConstant.heightRatio),
//            logoImage.trailingAnchor.constraint(equalTo: childView.trailingAnchor, constant: -59 * appConstant.heightRatio),
