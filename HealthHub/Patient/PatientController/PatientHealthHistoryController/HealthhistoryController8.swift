//
//  HealthhistoryController8.swift
//  HealthHub
//
...
protocol history8Delegate{
    func slider8BtnPress()
}

var history8Data : history8Delegate?

class HealthhistoryController8: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Have you been diagnosed with arthritis?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    {
        arthistics = "Yes"
        AppUserDefault.shared.arthistics = arthistics
        history8Data?.slider8BtnPress()
