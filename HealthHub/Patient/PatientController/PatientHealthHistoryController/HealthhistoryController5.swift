//
//  HealthhistoryController5.swift
//  HealthHub
//
...
protocol history5Delegate{
    func slider5BtnPress()
}

var history5Data : history5Delegate?


class HealthhistoryController5: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Have you been diagnosed with type 2 diabetes?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
...
//            headtitleLbl.heightAnchor.constraint(equalToConstant: 80 * appConstant.heightRatio),
    ...
    {
        diabetes2 = "Yes"
        AppUserDefault.shared.diabetes2 = diabetes2
        history5Data?.slider5BtnPress()
