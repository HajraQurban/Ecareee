...
protocol Doctorhistory1Delegate{
    func slider1BtnPress()
}

var Doctorhistory1Data : Doctorhistory1Delegate?

class DoctorBackgroundHistoryView1: UIView {
    ...
    lazy var logoImage : UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "HistLogo1")
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "How many years of work experience \ndo you have?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    lazy var passwordIcon : CustomButton = {
        ...
        btn.setImage(UIImage(named: "Hist1"), for: .normal)
...
//            numberingtitleLbl.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 161 * appConstant.heightRatio),
         ...
         //   logoImage.widthAnchor.constraint(equalToConstant: 175 * appConstant.heightRatio),
            ...
            poptitleLbl.heightAnchor.constraint(equalToConstant: 36 * appConstant.heightRatio),
...
//            buttonLbl.bottomAnchor.constraint(equalTo: buttonView.bottomAnchor,constant: -10 * appConstant.heightRatio),
    ...
    {
        Doctorhistory1Data?.slider1BtnPress()
    }
...
extension DoctorBackgroundHistoryView1: Doctorhistory1Delegate{
    func slider1BtnPress() {
