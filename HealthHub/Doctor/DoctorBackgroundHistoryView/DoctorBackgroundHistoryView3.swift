...
protocol Doctorhistory3Delegate{
    func slider3BtnPress()
}

var Doctorhistory3Data : Doctorhistory3Delegate?

class DoctorBackgroundHistoryView3: UIView {
    ...
    lazy var logoImage : UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "HistLogo3")
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "Are you currently working in a hospital?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
...
//            numberingtitleLbl.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 161 * appConstant.heightRatio),
         ...
         //   logoImage.widthAnchor.constraint(equalToConstant: 175 * appConstant.heightRatio),
            ...
            popView.topAnchor.constraint(equalTo: logoImage.bottomAnchor, constant: 22 * appConstant.heightRatio),
            popView.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 23 * appConstant.heightRatio),
            popView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -23 * appConstant.heightRatio),
            popView.heightAnchor.constraint(equalToConstant: 259 * appConstant.heightRatio),
            
            
            poptitleLbl.topAnchor.constraint(equalTo: popView.topAnchor, constant: 30 * appConstant.heightRatio),
            poptitleLbl.leadingAnchor.constraint(equalTo: popView.leadingAnchor, constant: 23 * appConstant.heightRatio),
...
//            buttonLbl.bottomAnchor.constraint(equalTo: buttonView.bottomAnchor,constant: -10 * appConstant.heightRatio),
    ...
    @objc func yesbtn_press(sender: UIButton)
    {
        ...
        else
        {
            ...
            sender.backgroundColor = UIColor(named: Colors.AppColor)
    ...
    @objc func nextbtn_press(sender: UIButton)
    {
        if isHworking == "Yes"
        {
        Doctorhistory3Data?.slider3BtnPress()
        }
        else
        {
...
extension DoctorBackgroundHistoryView3: Doctorhistory3Delegate{
    func slider3BtnPress() {
...
extension DoctorBackgroundHistoryView3: Doctorhistory4Delegate{
