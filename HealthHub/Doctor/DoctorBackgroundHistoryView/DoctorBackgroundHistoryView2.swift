...
protocol Doctorhistory2Delegate{
    func slider2BtnPress()
}

var Doctorhistory2Data : Doctorhistory2Delegate?

class DoctorBackgroundHistoryView2: UIView {
    ...
    lazy var poptitleLbl : UILabel = {
        ...
        lbl.text = "What area do you specialize in?"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    lazy var passwordIcon : CustomButton = {
        ...
        btn.setImage(UIImage(named: "Hist2"), for: .normal)
    ...
    lazy var PasswordTF : UITextField = {
        let tf = UITextField()
        tf.placeholder = "Heart specialist"
...
//            buttonLbl.bottomAnchor.constraint(equalTo: buttonView.bottomAnchor,constant: -10 * appConstant.heightRatio),
    ...
    {
        Doctorhistory2Data?.slider2BtnPress()
    }
...
extension DoctorBackgroundHistoryView2: Doctorhistory2Delegate{
    func slider2BtnPress() {
