//
//  DoctorAppointmentDetailsTVCell.swift
//  HealthHub
//
...
class DoctorAppointmentDetailsTVCell: UITableViewCell {
...
//        view.layer.shadowOffset = CGSize(width: 0, height: 0)
    ...
    lazy var Complaintitlename : UILabel = {
        let lbl = UILabel()
        lbl.clipsToBounds = true
        lbl.textColor = UIColor.black
        lbl.textAlignment = .left
    ...
    lazy var Complainname : UILabel = {
        let lbl = UILabel()
        lbl.clipsToBounds = true
        lbl.textColor = UIColor.black
        lbl.textAlignment = .left
        lbl.font = regular(size: 11)
        lbl.text = "High temperature"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    lazy var Complaindesctitlename : UILabel = {
        let lbl = UILabel()
        lbl.clipsToBounds = true
        lbl.textColor = UIColor.black
        lbl.textAlignment = .left
...
//        btn.addTarget(self, action: #selector(chnagebtn_press), for: .touchUpInside)
    ...
    func setupCell(){
        ...
        topView.addSubview(Complaintitlename)
        topView.addSubview(Complainname)
        topView.addSubview(Complaindesctitlename)
        
        topView.addSubview(Complaindesc)
...
//            Patientname.heightAnchor.constraint(equalToConstant: 20 * appConstant.heightRatio),
            ...
            Complaintitlename.topAnchor.constraint(equalTo: Patientname.bottomAnchor, constant: 5 * appConstant.heightRatio),
            Complaintitlename.leadingAnchor.constraint(equalTo: topView.leadingAnchor, constant: 21 * appConstant.widthRatio),
//            Complaintitlename.heightAnchor.constraint(equalToConstant: 20 * appConstant.heightRatio),
            
            Complainname.topAnchor.constraint(equalTo: Complaintitlename.bottomAnchor, constant: 5 * appConstant.heightRatio),
            Complainname.leadingAnchor.constraint(equalTo: topView.leadingAnchor, constant: 21 * appConstant.widthRatio),
//            Complainname.heightAnchor.constraint(equalToConstant: 20 * appConstant.heightRatio),

            
            Complaindesctitlename.topAnchor.constraint(equalTo: Complainname.bottomAnchor, constant: 5 * appConstant.heightRatio),
            Complaindesctitlename.leadingAnchor.constraint(equalTo: topView.leadingAnchor, constant: 21 * appConstant.widthRatio),
//            Complaindesctitlename.heightAnchor.constraint(equalToConstant: 20 * appConstant.heightRatio),
        

            Complaindesc.topAnchor.constraint(equalTo: Complaindesctitlename.bottomAnchor, constant: 5 * appConstant.heightRatio),
            Complaindesc.leadingAnchor.constraint(equalTo: topView.leadingAnchor, constant: 21 * appConstant.widthRatio),
            Complaindesc.trailingAnchor.constraint(equalTo: topView.trailingAnchor, constant: -21 * appConstant.widthRatio),
            Complaindesc.heightAnchor.constraint(equalToConstant: 36 * appConstant.heightRatio),
            ...
            lineView.topAnchor.constraint(equalTo: Complaindesc.bottomAnchor,constant: 5 * appConstant.heightRatio),
...
//            Calanderimg.bottomAnchor.constraint(equalTo: topView.bottomAnchor, constant: -10 * appConstant.heightRatio),
            ...
            deleteBtn.bottomAnchor.constraint(equalTo: topView.bottomAnchor, constant: -20 * appConstant.heightRatio),
