...
class DoctorAvailableSlotManagers{
    
    func availableslotlist(complition: @escaping(GetDoctorAvailableSlot?,String,Bool) -> Void){
        ...
        let url = URLConstants.doctor_available_slot
